...
<body>
    ...
    <div>
        <p class="text-center" style="margin-top: 50px;">Ingrese los estudiantes a la base de datos.<br>Nota: En el espacio de usuario se debe ingresar la cédula nuevamente, los estudiantes ingresan con su número de cédula y fecha de nacimiento.</p>
    </div>
    <div style="margin-top: 50px;margin-left: 20pxpx;margin-right: 20px;">
        <p class="lead" style="border-style: none;margin-left: 20px;font-family: Alike, serif;text-align: center;">Nombre:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input runat="server" name="Nombre" type="text"><br><br>Primer Apellido:&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<input runat="server" type="text" name="PrimerApellido"><br><br>Segundo Apellido:&nbsp; &nbsp; &nbsp;<input runat="server" type="text"  runat="server" name="SegundoApellido"><br><br>Cédula:&nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input  runat="server" name="Cedula" type="text"><br><br>Fecha de nacimiento:&nbsp;<input  runat="server" name="Nacimiento" type="text"><br><br>Administrador&nbsp; &nbsp;<input type="radio" name="roles" runat="server" id="Administrador">&nbsp;
            &nbsp; &nbsp;Estudiante&nbsp;&nbsp;<input type="radio" id="Estudiante" name="roles" runat="server"><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br><br>&nbsp;<button  onserverclick="BtnEnviar" runat="server" id="BUTTON1" class="btn btn-primary"
