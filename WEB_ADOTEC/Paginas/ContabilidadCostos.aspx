<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContabilidadCostos.aspx.cs" Inherits="WEB_ADOTEC.Paginas.ContabilidadCostos" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Contabilidad y Costos</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
                    <div class="intro">
                        <h1 class="text-center" style="border-bottom-style: solid;border-bottom-color: rgb(239,241,244);">Contabilidad y Costos</h1>
                    ...
                    <div class="text">
                        <p></p>
                        <p>▶&nbsp; &nbsp; &nbsp;Demuestra dominio en la aplicación de las Normas Internacionales de Información Financiera (NIIF), Normas Internacionales de Auditoría (NIA) y Principios de Contabilidad Generalmente Aceptados (PCGA).<br><br>▶&nbsp;
                            &nbsp; &nbsp;Aplica procedimientos y técnicas básicas para realizar auditorías.<br><br>▶&nbsp; &nbsp; &nbsp;Elabora programas de auditoría.<br><br>▶&nbsp; &nbsp; &nbsp;Demuestra la necesidad de aplicar auditorías en las empresas.<br><br>▶&nbsp;
                            &nbsp; &nbsp;Demuestra calidad en su trabajo.<br></p>
                        <h3 style="border-bottom-style: solid;border-bottom-color: rgb(239,241,244);">Perfil Ocupacional</h3>
                        <p style="margin-top: 20px;">▶&nbsp; &nbsp; &nbsp;Aplica el método de costeo basado en actividades.<br><br>▶&nbsp; &nbsp; &nbsp;Valúa en forma histórica y estándar, los costos indirectos de fabricación.<br><br>▶&nbsp; &nbsp; &nbsp;Presenta correctamente en
                            los estados financieros los costos indirectos.<br><br>▶&nbsp; &nbsp; &nbsp;Calcula los costos de importación de materiales.<br><br>▶&nbsp; &nbsp; &nbsp;Elabora presupuestos de ventas, mano de obra, producción, materiales y
                            otros.<br></p>
